...
export class AddContactDetailsPage extends BrowserInteractionsImpl {
    ...
    async checkRadio(value: string): Promise<void> {
    ...
    async selectStatus(value: string): Promise<void> {
        await this.selectDropdown(this.statusDropdown, { 'value': value });
    }

    async selectContactSorce(value: string): Promise<void> {
        await this.selectDropdown(this.contactSource, { 'value': value });
    }
    ...
    async checkCheckbox(value: string): Promise<void> {
